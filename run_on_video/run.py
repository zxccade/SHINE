...
import sys
sys.path.append('/data/scratch/acw761/demo/QD-DETR')
...
class QDDETRPredictor:
    ...
    def localize_moment(self, video_path, query_list):
        ...
        video_feats = torch.from_numpy(np.load('/data/scratch/acw761/Charades_features/i3d_features/{}.npy'.format(vid))).to(self.device)
...
def run_example():
    ...
    video_path = "run_on_video/example/X226B.mp4"
    query_path = "run_on_video/example/queries_X226B.jsonl"
    queries = load_jsonl(query_path)
    query_text_list = [e["query"] for e in queries]
    ckpt_path = "run_on_video/charades-video_tef-exp_charades_i3d-2024_02_03_10_40_24/model_best.ckpt"
